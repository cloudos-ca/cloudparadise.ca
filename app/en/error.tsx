...
// Nom distinct de `Error` : le composant partageait son nom avec le
// constructeur global, qu'il utilise pourtant dans le type de ses props juste
// en dessous. Next.js n'exige rien sur ce nom, seul l'export par défaut compte.
