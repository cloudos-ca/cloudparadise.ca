...
const TITRE = "Features: desktop, apps, compute, teamwork — Cloud OS";
const DESCRIPTION =
...
const SECTIONS: readonly SectionFonctions[] = [
  {
    ...
    entrees: [
      ...
      },
      {
        nom: "Assistant",
        texte:
          "It answers your questions about Cloud OS from the built-in documentation, and opens the right app for you.",
      },
      {
